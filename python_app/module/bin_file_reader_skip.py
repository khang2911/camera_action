    ...
    def read(self) -> List[Frame]:
        ...
        for frame in sorted_frame:
            ...
            if state %2 == 0:
                ...
                prev_FRAME.frame_index = frame_id
                new_frames.append(prev_FRAME)
...
if __name__ == "__main__":
    ...
    filepaths = [
    "/age_gender/detection/camera_action/storage/prod/hand/23-11-25/c03o24120000108_29b5dc15-9a62-4deb-b6ff-e1c127ccc874.bin",
    "/age_gender/detection/camera_action/storage/prod/hand/23-11-25/c03o24120000108_29b5dc15-9a62-4deb-b6ff-e1c127ccc874_v1.bin"
  ]
